...
#     base_bertopic = BERTopic(embedding_model='distilbert-base-nli-mean-tokens', verbose=False)
...
#     c_tf_idf = base_bertopic._extract_topics(old_documents.copy())
...
#                                   "Topic": np.random.randint(-1, nr_topics-1, len(newsgroup_docs))})
#     base_bertopic._update_topic_size(old_documents)
#     c_tf_idf = base_bertopic._extract_topics(old_documents)
#     old_freq = base_bertopic.get_topics_freq()
#
