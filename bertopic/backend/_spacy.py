    ...
    def embed(self, documents: List[str], verbose: bool = False) -> np.ndarray:
        ...
        for doc in tqdm(documents, position=0, leave=True, disable=not verbose):
            ...
            if embedding.has_vector:
                ...
                # Transformer pipeline design: https://spacy.io/models#design-trf
                try:
                    ...
                    embedding = embedding._.trf_data.last_hidden_layer_state.data    # or embedding._.trf_data.all_outputs[-1].data
